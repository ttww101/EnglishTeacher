#import "mBookmarkViewController.h"
#import "DetailViewController.h"

@interface mBookmarkViewController ()
{
    NSMutableArray *resultArray;
}
@end

@implementation mBookmarkViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DetailViewController *cc = [[DetailViewController alloc] initWithIndex:[[resultArray objectAtIndex:indexPath.row] objectAtIndex:0]];
