...
@property (nonatomic, strong) EnglishP1ViewController *feature1VC;
...
- (void)viewDidLoad {
    ...
    TermsPrivacyViewController *dVC = [[TermsPrivacyViewController alloc] init];
    [dVC setStartPage:@"https://lincangyicai.github.io/PrivacyPolicy.html"];
...
- (void)setContainerViewController {
    ...
    EnglishP1ViewController *vc2 = [EnglishP1ViewController new];
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:31.0f/255.0f
                                                       green:54.0f/255.0f
                                                        blue:32.0f/255.0f
                                                       alpha:1.0f]
                              //title font, size
                              titleAttributes:@{                                                                            NSFontAttributeName:[UIFont boldSystemFontOfSize:20],                                                         NSForegroundColorAttributeName:[UIColor colorWithRed:131.0f/255.0f
                                                                                                                                                                                                                                                                                         green:219.0f/255.0f
                                                                                                                                                                                                                                                                                          blue:195.0f/255.0f
                                                                                                                                                                                                                                                                                         alpha:1.0f]                                                                             }];
        ...
        if (i == button.tag) {
            ...
            switch (button.tag) {
                ...
                case 0:
                {
                    ...
                    EnglishP1ViewController *controllerD = [storyboard instantiateViewControllerWithIdentifier:@"english"];
                    [self.navigationController pushViewController:controllerD animated:YES];
                }
                    break;
